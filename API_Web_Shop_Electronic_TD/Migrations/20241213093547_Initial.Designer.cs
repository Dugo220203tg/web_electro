...
namespace API_Web_Shop_Electronic_TD.Migrations
{
    ...
    [Migration("20241213093547_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API_Web_Shop_Electronic_TD.Data.BanBe", b =>
                {
                    b.Property<int>("MaBb")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex(new[] { "MaHh" }, "IX_BanBe_MaHH");

                    b.HasIndex(new[] { "MaKh" }, "IX_BanBe_MaKH");

                    b.ToTable("BanBe", (string)null);
                });

            modelBuilder.Entity("API_Web_Shop_Electronic_TD.Data.ChiTietHd", b =>
                {
                    b.Property<int>("MaCt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex(new[] { "MaHd" }, "IX_ChiTietHD_MaHD");

                    b.HasIndex(new[] { "MaHh" }, "IX_ChiTietHD_MaHH");

                    b.ToTable("ChiTietHD", (string)null);
                });

            modelBuilder.Entity("API_Web_Shop_Electronic_TD.Data.ChuDe", b =>
                {
                    b.Property<int>("MaCd")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex(new[] { "MaNv" }, "IX_ChuDe_MaNV");

                    b.ToTable("ChuDe", (string)null);
                });

            modelBuilder.Entity("API_Web_Shop_Electronic_TD.Data.Coupon", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("API_Web_Shop_Electronic_TD.Data.DanhGiaSp", b =>
                {
                    b.Property<int>("MaDg")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("MaDg")
                        .HasName("PK_DanhGiaSP_1");

                    b.HasIndex(new[] { "MaHh" }, "IX_DanhGiaSP_MaHH");

                    b.HasIndex(new[] { "MaKh" }, "IX_DanhGiaSP_MaKH");

                    b.ToTable("DanhGiaSP", (string)null);
                });

            modelBuilder.Entity("API_Web_Shop_Electronic_TD.Data.DanhMucSp", b =>
                {
            ...
            modelBuilder.Entity("API_Web_Shop_Electronic_TD.Data.GopY", b =>
                {
                    ...
                    b.HasIndex(new[] { "MaCd" }, "IX_GopY_MaCD");

                    b.ToTable("GopY", (string)null);
                });

            modelBuilder.Entity("API_Web_Shop_Electronic_TD.Data.HangHoa", b =>
                {
                    b.Property<int>("MaHh")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex(new[] { "MaLoai" }, "IX_HangHoa_MaLoai");

                    b.HasIndex(new[] { "MaNcc" }, "IX_HangHoa_MaNCC");

                    b.ToTable("HangHoa", (string)null);
                });

            modelBuilder.Entity("API_Web_Shop_Electronic_TD.Data.HoaDon", b =>
                {
                    b.Property<int>("MaHd")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex(new[] { "MaTrangThai" }, "IX_HoaDon_MaTrangThai");

                    b.ToTable("HoaDon", (string)null);
                });

            modelBuilder.Entity("API_Web_Shop_Electronic_TD.Data.HoiDap", b =>
                {
                    b.Property<int>("MaHd")
                        .HasColumnType("int")
                        .HasColumnName("MaHD");
                    ...
                    b.HasIndex(new[] { "MaNv" }, "IX_HoiDap_MaNV");

                    b.ToTable("HoiDap", (string)null);
                });

            modelBuilder.Entity("API_Web_Shop_Electronic_TD.Data.KhachHang", b =>
                {
                    b.Property<string>("MaKh")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)")
            ...
            modelBuilder.Entity("API_Web_Shop_Electronic_TD.Data.Loai", b =>
                {
                    b.Property<int>("MaLoai")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API_Web_Shop_Electronic_TD.Data.NhaCungCap", b =>
                {
                    b.Property<string>("MaNcc")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
            ...
            modelBuilder.Entity("API_Web_Shop_Electronic_TD.Data.NhanVien", b =>
                {
                    b.Property<string>("MaNv")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
            ...
            modelBuilder.Entity("API_Web_Shop_Electronic_TD.Data.PayHistory", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Table__3214EC07BA1E86B4");

                    b.ToTable("PayHistory", (string)null);
                });

            modelBuilder.Entity("API_Web_Shop_Electronic_TD.Data.PhanCong", b =>
                {
                    b.Property<int>("MaPc")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex(new[] { "MaNv" }, "IX_PhanCong_MaNV");

                    b.HasIndex(new[] { "MaPb" }, "IX_PhanCong_MaPB");

                    b.ToTable("PhanCong", (string)null);
                });

            modelBuilder.Entity("API_Web_Shop_Electronic_TD.Data.PhanQuyen", b =>
                {
                    b.Property<int>("MaPq")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex(new[] { "MaPb" }, "IX_PhanQuyen_MaPB");

                    b.HasIndex(new[] { "MaTrang" }, "IX_PhanQuyen_MaTrang");

                    b.ToTable("PhanQuyen", (string)null);
                });

            modelBuilder.Entity("API_Web_Shop_Electronic_TD.Data.PhongBan", b =>
                {
                    b.Property<string>("MaPb")
                        .HasMaxLength(7)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("API_Web_Shop_Electronic_TD.Data.TrangThai", b =>
                {
                    b.Property<int>("MaTrangThai")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API_Web_Shop_Electronic_TD.Data.TrangWeb", b =>
                {
                    b.Property<int>("MaTrang")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API_Web_Shop_Electronic_TD.Data.YeuThich", b =>
                {
                    b.Property<int>("MaYt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex(new[] { "MaHh" }, "IX_YeuThich_MaHH");

                    b.HasIndex(new[] { "MaKh" }, "IX_YeuThich_MaKH");
            ...
            modelBuilder.Entity("API_Web_Shop_Electronic_TD.Data.BanBe", b =>
                {
                    b.HasOne("API_Web_Shop_Electronic_TD.Data.HangHoa", "MaHhNavigation")
                        .WithMany("BanBes")
                        .HasForeignKey("MaHh")
                    ...
                    b.HasOne("API_Web_Shop_Electronic_TD.Data.KhachHang", "MaKhNavigation")
                        .WithMany("BanBes")
                        .HasForeignKey("MaKh")
            ...
            modelBuilder.Entity("API_Web_Shop_Electronic_TD.Data.ChiTietHd", b =>
                {
                    b.HasOne("API_Web_Shop_Electronic_TD.Data.HoaDon", "MaHdNavigation")
                        .WithMany("ChiTietHds")
                        .HasForeignKey("MaHd")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("API_Web_Shop_Electronic_TD.Data.ChuDe", b =>
                {
                    b.HasOne("API_Web_Shop_Electronic_TD.Data.NhanVien", "MaNvNavigation")
                        .WithMany("ChuDes")
                        .HasForeignKey("MaNv")
                        .OnDelete(DeleteBehavior.Cascade)
            ...
            modelBuilder.Entity("API_Web_Shop_Electronic_TD.Data.GopY", b =>
                {
                    b.HasOne("API_Web_Shop_Electronic_TD.Data.ChuDe", "MaCdNavigation")
                        .WithMany("Gopies")
                        .HasForeignKey("MaCd")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("API_Web_Shop_Electronic_TD.Data.HangHoa", b =>
                {
                    b.HasOne("API_Web_Shop_Electronic_TD.Data.Loai", "MaLoaiNavigation")
                        .WithMany("HangHoas")
                    ...
                    b.HasOne("API_Web_Shop_Electronic_TD.Data.NhaCungCap", "MaNccNavigation")
                        .WithMany("HangHoas")
                        .HasForeignKey("MaNcc")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("API_Web_Shop_Electronic_TD.Data.HoaDon", b =>
                {
                    ...
                    b.HasOne("API_Web_Shop_Electronic_TD.Data.TrangThai", "MaTrangThaiNavigation")
                        .WithMany("HoaDons")
            ...
            modelBuilder.Entity("API_Web_Shop_Electronic_TD.Data.Loai", b =>
                {
                    b.HasOne("API_Web_Shop_Electronic_TD.Data.DanhMucSp", "DanhMuc")
                        .WithMany("Loais")
            ...
            modelBuilder.Entity("API_Web_Shop_Electronic_TD.Data.PhanCong", b =>
                {
                    ...
                    b.HasOne("API_Web_Shop_Electronic_TD.Data.PhongBan", "MaPbNavigation")
                        .WithMany("PhanCongs")
                        .HasForeignKey("MaPb")
                        .IsRequired()
            ...
            modelBuilder.Entity("API_Web_Shop_Electronic_TD.Data.PhanQuyen", b =>
                {
                    ...
                    b.HasOne("API_Web_Shop_Electronic_TD.Data.TrangWeb", "MaTrangNavigation")
                        .WithMany("PhanQuyens")

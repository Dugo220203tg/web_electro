...
namespace API_Web_Shop_Electronic_TD.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenDanhMuc = table.Column<string>(type: "nchar(10)", fixedLength: true, maxLength: 10, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DanhMucSP", x => x.MaDanhMuc);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GioiTinh = table.Column<bool>(type: "bit", nullable: true, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderInfo = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    Amount = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreateDate = table.Column<DateTime>(type: "datetime", nullable: true),
                    PayMethod = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    CouponCode = table.Column<string>(type: "nchar(10)", fixedLength: true, maxLength: 10, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Table__3214EC07BA1E86B4", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DanhMuc_id = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Categories", x => x.MaLoai);
                    table.ForeignKey(
                        name: "FK_Loai_DanhMucSP",
                        column: x => x.DanhMuc_id,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DienThoai = table.Column<string>(type: "nchar(10)", fixedLength: true, maxLength: 10, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NgaySX = table.Column<DateOnly>(type: "date", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaGiamGia = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DanhGiaSP_1", x => x.MaDG);
                    table.ForeignKey(
                        name: "FK_DanhGiaSP_HangHoa",
                        column: x => x.MaHH,
                        principalTable: "HangHoa",
                        principalColumn: "MaHH");
                    table.ForeignKey(
                        name: "FK_DanhGiaSP_KhachHang",
                        column: x => x.MaKH,
                        principalTable: "KhachHang",
                        principalColumn: "MaKH");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DanhGiaSP_MaHH",
                table: "DanhGiaSP",
                column: "MaHH");

            migrationBuilder.CreateIndex(
                name: "IX_DanhGiaSP_MaKH",
                table: "DanhGiaSP",
                column: "MaKH");
